...
const paymentStatus =
  ...
  const record = {
    ...
    status: "pending",
    payment_status: paymentStatus, // ✅ Will be "pending" for half payment
    payment_method: formData.payment_method,
    payment_type: paymentTypeLabel,
    total_bill: Math.round(tableBill),
    
    // ✅ FIX: Only set full_amount if payment type is FULL
    full_amount: formData.paymentType === "full" ? Math.round(tableBill) : null,
    
    // ✅ FIX: Only set half_amount if payment type is HALF
...
<div className="mb-5 relative">
  ...
  <input
    ...
    className={`w-full px-4 py-3 border-2 rounded-lg text-sm font-mono transition-all ${
